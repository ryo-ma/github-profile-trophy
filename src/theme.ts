export const COLORS: {[name: string]: Theme} = {
  ...
  nord: {
    ...
    SECRET_RANK_2: "#BF616A",
    SECRET_RANK_3: "#BF616A",
    SECRET_RANK_TEXT: "#BF616A",
    NEXT_RANK_BAR: "#818596",
    S_RANK_BASE: "#EBCB8B",
    S_RANK_SHADOW: "#EBCB8B",
    S_RANK_TEXT: "#3B4252",
    A_RANK_BASE: "#B48EAD",
    A_RANK_SHADOW: "#B48EAD",
    A_RANK_TEXT: "#3B4252",
    B_RANK_BASE: "#D08770",
    B_RANK_SHADOW: "#D08770",
    B_RANK_TEXT: "#3B4252",
    DEFAULT_RANK_BASE: "#8FBCBB",
    DEFAULT_RANK_SHADOW: "#8FBCBB",
  ...
  chalk: {
    ...
    TEXT: "#d4d4d4",
    LAUREL: "#a9d3ab",
    SECRET_RANK_1: "#d6add5",
    SECRET_RANK_2: "#79d4d5",
    SECRET_RANK_3: "#66d9ef",
    SECRET_RANK_TEXT: "#7e622a",
