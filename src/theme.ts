export const COLORS: {[name: string]: Theme} = {
  ...
  date: {
    ...
    TEXT: "E1B2A2",
    LAUREL: "#50fa7b",
    SECRET_RANK_1: "170F0C",
    SECRET_RANK_2: "170F0C",
    SECRET_RANK_3: "170F0C",
    SECRET_RANK_TEXT: "170F0C",
    NEXT_RANK_BAR: "DA7885",
    S_RANK_BASE: "#ffb86c",
    S_RANK_SHADOW: "#ffb86c",
    S_RANK_TEXT: "E1B2A2",
    A_RANK_BASE: "#8be9fd",
    ...
    B_RANK_SHADOW: "#ff5555",
    B_RANK_TEXT: "E1B2A2",
    DEFAULT_RANK_BASE: "E1B2A2",
    DEFAULT_RANK_SHADOW: "E1B2A2",
    DEFAULT_RANK_TEXT: "E1B2A2",
  }
};
