export const COLORS: { [name: string]: Theme } = {
  ...
  matrixhack: {
    ...
    TEXT: "#33ff66",
    LAUREL: "#00ff41",
    SECRET_RANK_1: "#ff0055",
    SECRET_RANK_2: "#00fff9",
    SECRET_RANK_3: "#39ff14",
    SECRET_RANK_TEXT: "#00ff41",
    NEXT_RANK_BAR: "#39ff14",
    S_RANK_BASE: "#00ff41",
    S_RANK_SHADOW: "#003b00",
    S_RANK_TEXT: "#000000",
    A_RANK_BASE: "#39ff14",
    A_RANK_SHADOW: "#004d00",
    A_RANK_TEXT: "#000000",
    B_RANK_BASE: "#2ecc40",
    B_RANK_SHADOW: "#0f3d0f",
    B_RANK_TEXT: "#000000",
    DEFAULT_RANK_BASE: "#1a4d1a",
    DEFAULT_RANK_SHADOW: "#0a1f0a",
    DEFAULT_RANK_TEXT: "#00ff41",
  },
  wired: {
    BACKGROUND: "#0a0e14",
    TITLE: "#4dd9e8",
    ...
    TEXT: "#7fb3bf",
    LAUREL: "#2b8fa3",
    SECRET_RANK_1: "#ff2d55",
    SECRET_RANK_2: "#4dd9e8",
    SECRET_RANK_3: "#8a2be2",
    SECRET_RANK_TEXT: "#4dd9e8",
    NEXT_RANK_BAR: "#2b8fa3",
    S_RANK_BASE: "#4dd9e8",
    S_RANK_SHADOW: "#0a3d47",
    S_RANK_TEXT: "#0a0e14",
    A_RANK_BASE: "#2b8fa3",
    A_RANK_SHADOW: "#0a2a30",
    A_RANK_TEXT: "#0a0e14",
    B_RANK_BASE: "#5a5a7a",
    B_RANK_SHADOW: "#1a1a2e",
    B_RANK_TEXT: "#0a0e14",
    DEFAULT_RANK_BASE: "#2a2a3a",
    DEFAULT_RANK_SHADOW: "#14141f",
    DEFAULT_RANK_TEXT: "#4dd9e8",
  },
  flat: {
    BACKGROUND: "#FFF",
    TITLE: "#000",
