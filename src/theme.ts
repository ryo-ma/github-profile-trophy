export const COLORS: { [name: string]: Theme } = {
  ...
  gotham: {
    ...
    TEXT: "#99d1ce",
    LAUREL: "#95B0B6",
    SECRET_RANK_1: "#4A0336 ",
    SECRET_RANK_2: "#4A0336",
    SECRET_RANK_3: "#7E3865",
    SECRET_RANK_TEXT: "#4A0336",
    NEXT_RANK_BAR: "#c23127",
    S_RANK_BASE: "#599cab",
    S_RANK_SHADOW: "#324B50",
    S_RANK_TEXT: "#4A0336",
    A_RANK_BASE: "#599cab",
    A_RANK_SHADOW: "#324B50",
    A_RANK_TEXT: "#4A0336",
    B_RANK_BASE: "#599cab",
    B_RANK_SHADOW: "#324B50",
    B_RANK_TEXT: "#4A0336",
