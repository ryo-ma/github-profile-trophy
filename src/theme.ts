export const COLORS: { [name: string]: Theme } = {
  ...
  dark_flame: {
    ...
    TEXT: "#DFDEE2",
    LAUREL: "#9ef01a",
    SECRET_RANK_1: "#e5383b",
    SECRET_RANK_2: "#ba181b",
    SECRET_RANK_3: "#ee9b00",
    SECRET_RANK_TEXT: "#660708",
    NEXT_RANK_BAR: "#4dc9e6",
    S_RANK_BASE: "#ee9b00",
    S_RANK_SHADOW: "#bb3e03",
    S_RANK_TEXT: "#ca6702",
    A_RANK_BASE: "#38b000",
    A_RANK_SHADOW: "#008000",
    A_RANK_TEXT: "#008000",
    B_RANK_BASE: "#2196f3",
    B_RANK_SHADOW: "#1976d2",
    B_RANK_TEXT: "#1976d2",
    DEFAULT_RANK_BASE: "#cccccc",
    DEFAULT_RANK_SHADOW: "#a5a5a5",
    DEFAULT_RANK_TEXT: "#333",
  },
};
